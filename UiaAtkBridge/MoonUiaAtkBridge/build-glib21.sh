...
LINKER_COMMON_FLAGS="-o $OUTPUT_PATH -d $INPUT_PATH -b true -m secattrs $MOONLIGHT_PATH/class/tuning/SecurityAttributes"

MONO_PATH="$LINKER_PATH:$$MONO_PATH" mono --debug $LINKER $LINKER_COMMON_FLAGS -a $INPUT_PATH/glib-sharp.dll $LINKER_STEPS
