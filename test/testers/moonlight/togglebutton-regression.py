...
assertText(tbFrame.toggle1, "Disable button2")
statesCheck(tbFrame.toggle1, "ToggleButton", \
...
assertText(tbFrame.toggle1, "Enable button2")
...
assertText(tbFrame.toggle2, "UnChecked")
statesCheck(tbFrame.toggle2, "ToggleButton", \
                                add_states=["focused"])
