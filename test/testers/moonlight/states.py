...
class ListViewTableCell(object):
    states = (ENABLED, FOCUSABLE, SELECTABLE, SENSITIVE, SHOWING, TRANSIENT, SINGLE_LINE, VISIBLE)

class TabControl(object):
    states = (ENABLED, SENSITIVE, SHOWING, VISIBLE)

class TabPage(object):
    states = (ENABLED, MULTI_LINE, FOCUSABLE, SELECTABLE, SENSITIVE, SHOWING, VISIBLE)
