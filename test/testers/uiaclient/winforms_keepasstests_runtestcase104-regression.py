...
# Date:        May 12 2010
# Description: RunTestCase104 for winforms KeePass application via UIAClientAPI
###############################################################################
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Winforms.KeePassTests.RunTestCase104" % uiatest_dll)
