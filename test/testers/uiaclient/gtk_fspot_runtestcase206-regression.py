...
# Date:        May 12 2010
# Description: RunTestCase206 for Gtk FSpot application via UIAClientAPI
###############################################################################
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Gtk.FSpot.RunTestCase206" % uiatest_dll)
