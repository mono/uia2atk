...
# Date:        May 12 2010
# Description: RunTestCase305 for Moonlight DiggSearchTest application via UIAClientAPI
###############################################################################
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Moonlight.DiggSearchTestTest.RunTestCase306 >%s%s" % \
