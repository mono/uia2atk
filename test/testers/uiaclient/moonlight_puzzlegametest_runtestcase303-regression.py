...
# Date:        May 12 2010
# Description: RunTestCase303 for Moonlight PuzzleGame application via UIAClientAPI
###############################################################################
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Moonlight.PuzzleGameTest.RunTestCase303" % uiatest_dll)
