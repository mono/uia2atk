...
# Date:        May 12 2010
# Description: RunTestCase102 for winforms KeePass application via UIAClientAPI
###############################################################################
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Winforms.KeePassTests.RunTestCase102" % uiatest_dll)
