...
uiatest_dll = os.path.join(test_path, dll_path, test_dll)
app = "WindowAndTransformPatternProvider.exe"
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Winforms.WindowPatternTests.RunTestCase106 >%s%s" % \
