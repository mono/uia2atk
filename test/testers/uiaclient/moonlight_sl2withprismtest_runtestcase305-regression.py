...
# Date:        May 12 2010
# Description: RunTestCase305 for Moonlight SL2WithPrism application via UIAClientAPI
###############################################################################
...
os.system("nunit-console2 %s -run=MonoTests.Mono.UIAutomation.UIAClientAPI.Moonlight.SL2WithPrismTest.RunTestCase305" % uiatest_dll)
