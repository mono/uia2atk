...
sequence.append(utils.AssertPresentationAction(
    ...
    ["BRAILLE LINE:  'label1 in splitcontainer.panel1 label2 in splitcontainer.panel2'",
     "     VISIBLE:  'label1 in splitcontainer.panel1 ', cursor=1",
     "SPEECH OUTPUT: 'label1 in splitcontainer.panel1 label2 in splitcontainer.panel2'"]))
