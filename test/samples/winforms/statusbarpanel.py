...
class StatusBarStatusBarPanelApp(Form):
    ...
    def __init__(self):
        ...
        self.statusbarpanel1.Icon = Icon("%s/icons/TrayIcon.ico" % uiaqa_path)
        ...
        self.statusbarpanel2.Icon = Icon("%s/icons/apple.ico" % uiaqa_path)
        ...
        self.statusbarpanel3.Icon = Icon("%s/icons/novell.ico" % uiaqa_path)
