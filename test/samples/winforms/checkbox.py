...
class CheckBoxApp(Form):
    ...
    def __init__(self):
        ...
        self.check5.Image = Image.FromFile("%s/winforms/opensuse60x38.gif" % uiaqa_path)
        ...
        self.check6.BackgroundImage = Image.FromFile("%s/winforms/tiny_background.png" % uiaqa_path)
