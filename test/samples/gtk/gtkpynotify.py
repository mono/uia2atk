...
class ButtonSample:
    ...
    def button_clicked(self, widget, data=None):
        ...
        if widget is self.button1:
            message = "you clicked button 1"
        elif widget is self.button2:
            message = "you clicked button 2"
        elif widget == self.button3:
    ...
    def __init__(self):
        ...
        # Now when the button is clicked, we call the button_clicked method
        ...
        self.button3.connect("clicked", self.button_clicked)
        self.button2.show()
        self.button3.show()
        self.box1.show()
        self.window.show()
